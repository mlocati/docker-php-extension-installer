...
| imagick[*](#special-requirements-for-imagick) | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; |  |
...
| <a name="special-requirements-for-imagick"></a>imagick | Not available in `alpine3.19` docker images |
