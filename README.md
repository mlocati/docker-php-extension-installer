...
| intl[*](#special-requirements-for-intl) | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; | &check; |
...
| <a name="special-requirements-for-intl"></a>intl | Not available in `alpine3.22` docker images |
